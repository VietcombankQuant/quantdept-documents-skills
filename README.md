...
Đây là một skill dành cho Claude (và các agent hỗ trợ định dạng skill tương tự). Nó giúp agent soạn thảo, chỉnh sửa và kiểm tra văn bản hành chính tiếng Việt — tờ trình, báo cáo, giải trình, công văn, thư điện tử — cũng như trang trình chiếu PowerPoint cho Phòng Mô hình và Công cụ Quản trị Rủi ro (Phòng Quant), Vietcombank.
...
│   ├── Slide mẫu Phòng Quant.pptx   # Template PowerPoint 16:9, 17 layout dựng sẵn.
...
- **Mô tả là thứ quyết định skill có được gọi hay không.** Viết bằng đúng từ ngữ người dùng sẽ nói, và nói rõ *khi nào* thì dùng skill.
- **Mỗi skill làm một việc.**
